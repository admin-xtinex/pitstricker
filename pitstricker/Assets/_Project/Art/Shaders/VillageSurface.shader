Shader "Pit Striker/Village Surface"
{
    ...
    SubShader
    {
        ...
        struct V {float4 p:SV_POSITION;float3 world:TEXCOORD0;float3 n:TEXCOORD1;float2 uv:TEXCOORD2;float fog:TEXCOORD3;float3 t:TEXCOORD4;float3 b:TEXCOORD5;};
        V vert(A a)
        {
            V o; VertexPositionInputs p=GetVertexPositionInputs(a.p.xyz); VertexNormalInputs n=GetVertexNormalInputs(a.n,a.tangent);
            o.p=p.positionCS;o.world=p.positionWS;o.n=n.normalWS;o.t=n.tangentWS;o.b=n.bitangentWS;o.uv=TRANSFORM_TEX(a.uv,_BaseMap);o.fog=ComputeFogFactor(o.p.z);return o;
        }
        ENDHLSL
        Pass
        {
            ...
            half4 frag(V i):SV_Target
            {
                ...
                InputData d=(InputData)0;d.positionWS=i.world;d.normalWS=normalize(i.n+n.x*i.t+n.y*i.b);
                d.viewDirectionWS=GetWorldSpaceNormalizeViewDir(i.world);d.shadowCoord=TransformWorldToShadowCoord(i.world);
                d.bakedGI=max(SampleSH(d.normalWS),half3(.13,.15,.17));d.normalizedScreenSpaceUV=GetNormalizedScreenSpaceUV(i.p);d.shadowMask=1;
